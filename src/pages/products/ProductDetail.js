    ...
    <ContainerFixed className="px-2 py-2">
      <div className="flex flex-col gap-y-4">
        ...
        <div className="grid gap-x-4 gap-y-2">
          <div className="basis-5/12 md:basis-1/6 order-1">
            <img
          ...
          <div className="basis-full order-3 md:order-2 md:basis-4/6">설명</div>
          <div className="basis-7/12 order-2 md:order-3 md:basis-1/6 flex flex-col gap-y-2">
            <h2>한게임상품권 5만원</h2>
            <p>
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <ul className="list-disc list-inside flex flex-col gap-y-2">
            <li>상품권 확인은 사이트 [주문내역] 에서 확인합니다.</li>
            <li>
            ...
            <li>
              ...
              못한 경우 [고객문의]에 주문번호, 입금은행, 입금시각을 남겨주세요.
            </li>
            <li>
